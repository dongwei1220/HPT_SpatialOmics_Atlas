...
work_path = args$work_path # "/mnt/hpc/users/data/2results/T2T/A2TR4/scRNA_A2TR4/fastq"
inpu_name = args$file_name # "RNA_exp1_0123_A2TR4_2.extract.barcode"
refe_path = args$combine_barcode # "/mnt/hpc/users/data/Spatial_barcodes/combined_96_barcode.txt"
